...
public class SupportedAnnotationsTest {
    ...
    private final AnnotationCache annotationCache = null;
    ...
    public void jsr305DefaultReturnsTrue_whenAnnotationHasNonnullAnnotation() {
        ...
        boolean actual = SupportedAnnotations.JSR305_DEFAULT_ANNOTATION_NONNULL.validate(annotationCache, props, NO_IGNORED_ANNOTATIONS);
        assertTrue(actual);
    }
