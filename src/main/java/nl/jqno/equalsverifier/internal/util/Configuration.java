...
public final class Configuration<T> {
    ...
    public static <T> Configuration<T> of(Class<T> type) {
        AnnotationCache annotationCache = new AnnotationCache(new AnnotationAccessor(null, null, null, false));
        return new Configuration<>(type, new PrefabValues(annotationCache), annotationCache, new ArrayList<>(), new ArrayList<>(),
    ...
    public ClassAccessor<T> createClassAccessor() {
        return ClassAccessor.of(type, prefabValues, annotationCache);
    }
