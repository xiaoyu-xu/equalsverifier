...
public final class JavaApiPrefabValues {
    ...
    private void addClasses() {
        ...
        addFactory(ThreadLocal.class, new GenericContainerFactory<>(a -> ThreadLocal.withInitial(() -> a)));
    ...
    private void addJava8ApiClasses() {
        addFactory(Optional.class, new GenericContainerFactory<>(Optional::of));
        addFactory(CompletableFuture.class, new GenericContainerFactory<>(ignored -> new CompletableFuture<>()));
