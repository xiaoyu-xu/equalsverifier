 ...
 */
public interface AbstractReflectiveGenericFactory<T> extends PrefabValueFactory<T> {
    public static final TypeTag OBJECT_TYPE_TAG = new TypeTag(Object.class);

    public default LinkedHashSet<TypeTag> cloneWith(LinkedHashSet<TypeTag> typeStack, TypeTag tag) {
    ...
    public default TypeTag copyGenericTypesInto(Class<?> type, TypeTag source) {
    ...
    public default TypeTag determineAndCacheActualTypeTag(int n, TypeTag tag, PrefabValues prefabValues,
    ...
    public default TypeTag determineActualTypeTagFor(int n, TypeTag typeTag) {
    ...
    public default void invoke(Class<?> type, Object receiver, String methodName, Class<?>[] classes, Object[] values) {
        try {
